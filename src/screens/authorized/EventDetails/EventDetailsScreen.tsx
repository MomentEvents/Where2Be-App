...
const EventDetailsScreen = ({ route }) => {
  ...
  const [showRetryAll, setShowRetryAll] = useState<boolean>(false);
  const [showRetryHost, setShowRetryHost] = useState<boolean>(false);
    ...
    <View style={styles.container}>
      {
        showRetryAll? (
          ...
          >
            ...
            <RetryButton setShowRetry={setShowRetryAll} retryCallBack={pullData} style={{ alignItems: 'center', justifyContent: 'center' }}/>
          </View>
        ) : (
          <>
          <ImageView
            ...
            >
              ...
              <View style={styles.scrollcontainer}>
                ...
                <HostSection>
                  {
                    showRetryHost? (
                      <RetryButton setShowRetry={setShowRetryHost} retryCallBack={handleGetEventHostByEventId} style={{ alignItems: 'center', justifyContent: 'center' }}/>
                    ) : (
                      <TouchableOpacity
                        style={{
                          maxWidth: "80%",
